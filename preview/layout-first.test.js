...
assert.match(actionStatus.textContent, /Using solo\./, "a keyboard layout change is announced to screen readers");
...
assert.match(actionStatus.textContent, /Using panel\./, "ArrowDown announces the layout it lands on");
